...
(def townsfolk 
  {:weak ["SLASHING" "PIERCING"]
   :resistant ["PIERCING"]
   :desc [["An entranced farmer dragging a pitchfork" "He jabs the pitchfolk vaguely in your direction. " "piercing"]
          ["A traitor town guard" "He yells 'Better you than me!' and stabs you with a pike. " "slashing"]
          ["The town drunk" "She hits you with a half-empty bottle of moonshine. " "bludgeoning"]
...
(def cultist 
  {:weak ["ARCANE"] 
   ...
   :desc [["A creepily cheerful cultist" "He sings a cheerful song about sacrificing you to The Old Gods. " "spooky"]
          ...
          ["A cultist training vampire rabbits" "Bunnicula attempts to suck your blood. " "piercing"]
